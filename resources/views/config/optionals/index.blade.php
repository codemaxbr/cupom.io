...
@section('content')
    ...
    <div class="row page-title clearfix">
        <div class="page-title-left">
            <h6 class="page-title-heading mr-0 mr-r-5">Itens Opcionais</h6>
        ...
        <div class="page-title-right d-none d-sm-inline-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Itens Opcionais</li>
            </ol>
        </div>
        <!-- /.page-title-right -->
    </div>
    ...
    @if (session('deleted'))
        <div class="alert alert-success">
            <i class="icone-ok-3"></i>
            O opcional <b>{{ session('deleted') }}</b> foi removido.
        </div>
    @endif

    <div class="alert alert-success" id="deleteJSON" style="display: none;">
        <i class="icone-ok-3"></i>
        Os <b class="qtd_select"></b> opcionais selecionados foram removidos.
    </div>
                    ...
                    <div class="widget-body">
                            ...
                            <div class="col-md-6">
                                <div class="mail-inbox-tools d-flex align-items-center">
                                    ...
                                    <div class="d-none d-sm-block text-right mr-r-20">
                                        <a href="{{ route('config.optionals.add') }}" class="btn btn-primary btn-sm fs-14">Adicionar Opcional</a>
                                    </div>
                            ...
                            <table class="table table-hover" id="tabela_clientes">
                                ...
                                @foreach($optionals as $optional)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('config.optionals.edit', $optional->id)}}">{{ $optional->name }}</a>
                                        </td>
                                        <td>R$ {{ numFormat($optional->price) }}</td>
                                        <td>{{ $optional->payment_cycle->name }}</td>
                                        <td><strong class="text-dark">{{ $optional->subscriptions_count }}</strong></td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="{{route('config.plans.edit', $optional->id)}}" class="link-btn">
                        ...
                        <div class="row">
                            ...
                            <span class="headings-font-family">
                                Exibindo de {{ $optionals->firstItem() }} à {{ $optionals->lastItem() }} de <b>{{ $optionals->total() }}</b> registros
                            </span>
                            </div>
