...
<div class="row page-title clearfix">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">Clientes</h6>
                        ...
                        <div class="col-md-6">
                            <div class="mail-inbox-tools d-flex align-items-center">
                                ...
                                <div class="d-none d-sm-block text-right mr-r-20">
                                    <a href="{{ route('customers.view.add') }}" class="btn btn-primary btn-sm fs-14">Adicionar cliente ou fornecedor</a>
                                </div>
                                ...
                                <form action="{{ route('customers.search.simple') }}" method="get">
                                    ...
                                    <div class="form-group" style="margin-bottom: 0px;">
                                        <div class="input-group input-group-sm">
                                            <input class="form-control fs-14 input_busca" id="l8" name="busca" placeholder="Buscar clientes..." type="text">
                    ...
                    <form method="post" id="lista_cadastros">
                        ...
                        <table class="table table-hover" id="tabela_clientes">
                            ...
                            <tr>
                                ...
                                <th>Telefone</th>
                                <th>CPF / CNPJ</th>
                                <th class="text-right">Cliente desde</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($clientes as $cliente)
                                <tr>
                                    <td>
                                        <input name="uuid" class="td_item" value="{{ $cliente->uuid }}" nome="{{ $cliente->name }}" type="checkbox" />
                                    </td>
                                    <td>
                                        <a href="{{ route('customers.view', $cliente->uuid) }}">{{ $cliente->name }}</a>
                                    </td>
                                    <td>{{ $cliente->email }}</td>
                                    <td>{{ $cliente->phone }}</td>
                    ...
                    <div class="row">
                        <div class="col-7 mt-1">
                            <span class="headings-font-family">
                                Exibindo de {{ $clientes->firstItem() }} à {{ $clientes->lastItem() }} de <b>{{ $clientes->total() }}</b> registros
                            </span>
                        </div>
