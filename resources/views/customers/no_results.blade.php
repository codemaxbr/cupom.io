        ...
        <div class="no-registry-content nenhum_registro">
            ...
            <div class="fade-item">
                <h2 class="no-result-title">
                    Nenhum <b>cliente/fornecedor</b> registrado
                </h2>

                <div class="no-result-info">
                    <p>
                        Cadastre seus clientes e fornecedores para gerar boletos, assinaturas, abrir tickets de suporte
                        e etc.<br />O cadastro pode ser de pessoas jurídicas (CNPJ) ou pessoas físicas (CPF), gerencie os dados
                        pessoais, histórico financeiro, serviços contratados em um único lugar.
                    </p>

                    <div class="buttons">
                        <a href="{{ route('customers.view.add') }}" class="btn btn-primary">
                            <i class="icone-user-add"></i>
                            Adicionar novo
                        </a>
