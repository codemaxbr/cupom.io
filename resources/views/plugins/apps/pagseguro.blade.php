    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-7 pd-l-20 pd-b-20 pd-r-10 bg-gray1">
                ...
                <img src="{{ asset('images/modules/gateways/pagseguro.png') }}" class="mr-20 mr-l-0" style="max-height: 40px">
                ...
                <p>
                    ...
                    <small>( Com base na configuração da sua conta PagSeguro, os tipos de cartão podem variar. )</small>
            ...
            <div class="col-md-5 pd-20">
                ...
                <form action="{{ ($config != null) ? route('plugin.update', $module->id) : route('plugin.save', $module->id) }}" method="post" class="config-plugin">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" value="{{ ($config != null) ? $config->email : old('email') }}">
                    </div>

                    <div class="form-group">
                        <label for="token">Token</label>
                        <input type="text" id="token" name="token" class="form-control" value="{{ ($config != null) ? $config->token : old('token') }}">
                    </div>
